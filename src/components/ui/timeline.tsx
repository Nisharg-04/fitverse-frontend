  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-5xl mb-4 text-foreground max-w-4xl mt-4">
          Your Fitness Transformation Journey
        </h2>
        <p className="text-muted-foreground text-sm md:text-base max-w-sm">
          Follow these proven steps to transform your body, mind, and lifestyle with FitVerse.
        </p>
      </div>
